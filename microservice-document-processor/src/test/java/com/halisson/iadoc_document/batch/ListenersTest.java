...
class ListenersTest {
    ...
    private DocumentJobExecutionListener jobListener;
    private DocumentStepExecutionListener stepListener;
    private JobCompletionNotificationListener completionListener;

    @BeforeEach
    void setUp() {
        jobListener = new DocumentJobExecutionListener(jobExplorer);
        stepListener = new DocumentStepExecutionListener(jobExplorer);
